...
def nullable(r):
    ...
    if type(r) == Char:
        return False
    if type(r) == Concat:
        return nullable(r.arg1) and nullable(r.arg2)
    if type(r) == Alt:
        return nullable(r.arg1) or nullable(r.arg2)
    if type(r) == Star:
        return True
...
def derivative(a: Char, r):
    ...
    if type(r) == Concat:
        if nullable(r.arg1):
            ...
            return Concat(derivative(a, r.arg1), r.arg2)


def match(r, s):
    return nullable(derivative_str(s, r))
